...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const url = `https://viadreams.cc/${lang}/tools/json-to-go`;
  return {
    title: t.pageTitle,
    ...
    alternates: { canonical: url, languages: Object.fromEntries(i18n.locales.map((l) => [l, `https://viadreams.cc/${l}/tools/json-to-go`])) },
  };
}
