...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const t = await getToolEntry(lang, 'crontab-generator');
  const url = `https://viadreams.cc/${lang}/tools/crontab-generator/`;
  return {
    title: t?.pageTitle,
    ...
    alternates: {
      canonical: url,
      languages: {
        ...Object.fromEntries(i18n.locales.map((l) => [l, `https://viadreams.cc/${l}/tools/crontab-generator/`])),
        'x-default': `https://viadreams.cc/en/tools/crontab-generator/`,
      },
    },
  };
}
