...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const t = (await getToolEntry(validLang as Locale, TOOL_ID)) || { pageTitle: 'htpasswd Generator', pageDescription: 'Generate Apache htpasswd entries for basic authentication' };
