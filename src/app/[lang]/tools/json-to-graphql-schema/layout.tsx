...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const t = dict.tools['json-to-graphql-schema'];
  const url = `https://viadreams.cc/${lang}/tools/json-to-graphql-schema`;
  return {
    ...
    alternates: { canonical: url, languages: { ...Object.fromEntries(i18n.locales.map((l) => [l, `https://viadreams.cc/${l}/tools/json-to-graphql-schema`])), 'x-default': `https://viadreams.cc/en/tools/json-to-graphql-schema` } },
  };
}
...
export default async function Layout({ children, params }: { children: React.ReactNode; params: Promise<{ lang: string }> }) {
  const { lang: rawLang } = await params;
  const lang = (i18n.locales.includes(rawLang as Locale) ? rawLang : i18n.defaultLocale) as Locale;
  return <ToolSeoServer toolId="json-to-graphql-schema" lang={lang}>{children}</ToolSeoServer>;
}
