          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button onClick={() => fromHex()} className="btn btn-primary" style={{ flexShrink: 0 }}>{dict.common.convert}</button>
              </div>
            </div>
            <div>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button onClick={fromRgb} className="btn btn-primary" style={{ flexShrink: 0 }}>{dict.common.convert}</button>
              </div>
            </div>
            <div>
            ...
            <button onClick={randomColor} className="btn btn-secondary" style={{ width: '100%' }}>🎲 {t.randomColor}</button>
            <div>
