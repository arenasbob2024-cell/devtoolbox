...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const t = (await getToolEntry(validLang as Locale, TOOL_ID)) || { pageTitle: 'JSON Patch Tool', pageDescription: 'Apply JSON Patch operations (RFC 6902) to JSON documents' };
