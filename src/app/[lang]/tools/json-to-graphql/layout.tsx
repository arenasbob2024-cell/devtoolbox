...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const t = dict.tools['json-to-graphql'];
  ...
  return {
    ...
    alternates: { canonical: url, languages: Object.fromEntries(i18n.locales.map((l) => [l, `https://viadreams.cc/${l}/tools/json-to-graphql`])) },
  };
}
