...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const t = await getToolEntry(lang, 'json-to-graphql');
  const url = `https://viadreams.cc/${lang}/tools/json-to-graphql/`;
  return {
    title: t?.pageTitle,
    ...
    alternates: { canonical: url, languages: {
        ...Object.fromEntries(
          i18n.locales.map((l) => [l, `https://viadreams.cc/${l}/tools/json-to-graphql/`])
        ),
        'x-default': `https://viadreams.cc/en/tools/json-to-graphql/`,
      } },
  };
}
