...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const t = dict.tools['oauth-debugger'];
  const url = `https://viadreams.cc/${lang}/tools/oauth-debugger`;
  return {
    title: t.pageTitle,
    ...
    alternates: { canonical: url, languages: { ...Object.fromEntries(i18n.locales.map((l) => [l, `https://viadreams.cc/${l}/tools/oauth-debugger`])), 'x-default': `https://viadreams.cc/en/tools/oauth-debugger` } },
  };
}
