...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const t = (await getToolEntry(validLang as Locale, TOOL_ID)) || { pageTitle: 'Docker Compose Validator', pageDescription: 'Validate Docker Compose YAML configuration files' };
