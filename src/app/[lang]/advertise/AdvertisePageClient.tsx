    ...
    packages: [
      {
        ...
        inventory: 'Category page CTA, relevant tool sidebar CTA, post-tool sponsor/ad fallback, and selected tool-page partner placement.',
      ...
      },
      {
        ...
        inventory: 'Article sponsor CTA, mid-article sponsor/ad fallback, related tool block, and optional blog-list presence.',
    ...
    packages: [
      {
        ...
        inventory: '分类页 CTA、相关工具侧边栏 CTA、工具主体下方赞助/广告兜底，以及精选工具页合作推荐位。',
      ...
      },
      {
        ...
        inventory: '文章赞助 CTA、文章中段赞助/广告兜底、相关工具模块，以及可选博客列表曝光。',
    ...
    packages: [
      {
        ...
        inventory: 'CTA на странице категории, CTA в боковой панели релевантных инструментов, post-tool sponsor/ad fallback и партнерское размещение на выбранных страницах.',
      ...
      },
      {
        ...
        inventory: 'CTA в статье, mid-article sponsor/ad fallback, блок связанных инструментов и опциональное присутствие в списке блога.',
