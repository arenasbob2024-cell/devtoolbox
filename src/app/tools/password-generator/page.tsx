...
function getStrength(password: string): { score: number; label: string; color: string } {
  ...
  if (score <= 4) return { score, label: 'Medium', color: 'var(--accent-orange)' };
  ...
  return (
    ...
    >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
              <label style={{ fontSize: 13, fontWeight: 600 }}>Length</label>
          ...
          <button onClick={generate} className="btn btn-primary" style={{ width: '100%' }}>Generate Passwords</button>
        </div>
      ...
      <div style={{ marginTop: 30, paddingTop: 20, borderTop: '1px solid var(--border-color)' }}>
        <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 12 }}>About Password Security</h2>
