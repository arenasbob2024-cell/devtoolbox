...
export default function MarkdownPreview() {
  ...
  return (
    <ToolLayout
      ...
      description="Write Markdown and preview the rendered HTML in real time. Side-by-side editor and preview."
      toolId="markdown-preview"
    >
      <div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
        <button onClick={() => setInput(sampleMd)} className="btn btn-secondary" style={{ fontSize: 12 }}>Load Sample</button>
        <button onClick={() => setInput('')} className="btn btn-secondary" style={{ fontSize: 12 }}>Clear</button>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, minHeight: 400 }}>
        <div>
          <label style={{ fontSize: 12, fontWeight: 600, display: 'block', marginBottom: 6, color: 'var(--text-secondary)' }}>MARKDOWN</label>
          <textarea
            value={input}
        ...
        <div>
          <label style={{ fontSize: 12, fontWeight: 600, display: 'block', marginBottom: 6, color: 'var(--text-secondary)' }}>PREVIEW</label>
          <div
            style={{
      ...
      <div style={{ marginTop: 30, paddingTop: 20, borderTop: '1px solid var(--border-color)' }}>
        <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 12 }}>About Markdown</h2>
