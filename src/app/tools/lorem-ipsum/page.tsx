...
export default function LoremIpsum() {
  ...
  return (
    <ToolLayout
      ...
      description="Generate placeholder text in paragraphs, sentences, or words for design and development."
      toolId="lorem-ipsum"
    >
      <div style={{ display: 'flex', gap: 8, marginBottom: 16, alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        {output && <CopyButton text={output} label="Copy All" />}
      </div>
      ...
      <div style={{ marginTop: 30, paddingTop: 20, borderTop: '1px solid var(--border-color)' }}>
        <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 12 }}>About Lorem Ipsum</h2>
        <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7 }}>
          Lorem Ipsum is dummy text used in the printing and typesetting industry since the 1500s. Designers and developers use it as placeholder text when actual content isn&apos;t available yet. It helps visualize layouts without distracting readers with meaningful content.
        </p>
      </div>
    </ToolLayout>
  );
