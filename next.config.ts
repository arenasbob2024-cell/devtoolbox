...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/:lang/tools/ascii-table-generator', destination: '/:lang/tools/html-table', permanent: true },
      { source: '/:lang/tools/base64-decode', destination: '/:lang/tools/base64-decoder', permanent: true },
      ...
      { source: '/:lang/tools/base64-to-image', destination: '/:lang/tools/base64-image-converter', permanent: true },
      ...
      { source: '/:lang/tools/cron-expression-generator', destination: '/:lang/tools/cron-generator', permanent: true },
      ...
      { source: '/:lang/tools/http-header-checker', destination: '/:lang/tools/http-header-analyzer', permanent: true },
      ...
      { source: '/:lang/tools/json-minifier-online', destination: '/:lang/tools/json-minifier', permanent: true },
      { source: '/:lang/tools/json-minifier-online-new', destination: '/:lang/tools/json-minifier', permanent: true },
      { source: '/:lang/tools/json-minify-online', destination: '/:lang/tools/json-minifier', permanent: true },
      { source: '/:lang/tools/json-path-finder', destination: '/:lang/tools/json-viewer', permanent: true },
      { source: '/:lang/tools/json-path-tester', destination: '/:lang/tools/json-path-finder', permanent: true },
      ...
      { source: '/:lang/tools/markdown-table-generator', destination: '/:lang/tools/html-table', permanent: true },
      ...
      { source: '/:lang/tools/sha256-hash-online', destination: '/:lang/tools/sha256-hash-generator', permanent: true },
